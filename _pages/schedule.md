...
<section class="section" id="coursework">
  ...
  <ul class="info-grid">
    ...
    <li class="info-card">
      ...
      <span class="info-card__hint">Document out Sep 17. Team form Oct 6. Proposal Due Oct 27. Mid-term check point Nov 10. Final report Dec 3. Presentation date TBD.</span>
    </li>
  </ul>
</section>
